      ...
      <div class="col-12">
        <div class="box">
          ...
          <div class="box-header">
              <h4 class="box-title">Edit Minuman</h4>  
          </div>
            ...
            <div class="box-body">
              <div class="form-group row">
                ...
                <div class="col-md-10 mb-3">
                  <input class="form-control" type="text" name="nama" required value="{{ $minuman->nama }}">
                </div>
              </div>		
              <div class="form-group row">
                <label class="col-form-label col-md-2">Harga</label>
                <div class="col-md-10 mb-3">
                    <input class="form-control" type="number" name="harga" value="{{ $minuman->harga }}">
                </div>
              </div>
              <div class="form-group row">
                <label class="col-form-label col-md-2">Stok</label>
                <div class="col-md-10 mb-3">
                    <input class="form-control" type="text" name="stok" value="{{ $minuman->stok }}">
                </div>
              </div>
            </div>
