      ...
      <div class="navbar-custom-menu r-side">
        <ul class="nav navbar-nav">
		  ...
		  <li class="dropdown notifications-menu">
			<a href="{{ url("#") }}" class="waves-effect waves-light rounded dropdown-toggle" data-toggle="dropdown" title="Notifications">
			  <i class="ti-bell"></i>
			</a>
			  ...
			  <li class="header">
				<div class="p-20">
					<div class="flexbox">
						...
						<div>
							<a href="{{ url("#") }}" class="text-danger">Clear All</a>
						</div>
					</div>
				</div>
			  </li>
          ...
          <li class="dropdown user user-menu">	
			...
			<ul class="dropdown-menu animated flipInX">
			  <li class="user-body">
				 <a class="dropdown-item" href="{{ url("#") }}"><i class="ti-user text-muted mr-2"></i> Profile</a>
		  ...
		  <li>
              <a href="{{ url("#") }}" data-toggle="control-sidebar" title="Setting" class="waves-effect waves-light">
      ...
      <ul class="sidebar-menu" data-widget="tree">  
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ url("chat.html") }}"><i class="ti-more"></i>Chat</a></li>
            <li><a href="{{ url("calendar.html") }}"><i class="ti-more"></i>Calendar</a></li>
          </ul>
        </li> 
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ url("mailbox_inbox.html") }}"><i class="ti-more"></i>Inbox</a></li>
            <li><a href="{{ url("mailbox_compose.html") }}"><i class="ti-more"></i>Compose</a></li>
            <li><a href="{{ url("mailbox_read_mail.html") }}"><i class="ti-more"></i>Read</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ url("profile.html") }}"><i class="ti-more"></i>Profile</a></li>
            <li><a href="{{ url("invoice.html") }}"><i class="ti-more"></i>Invoice</a></li>
            <li><a href="{{ url("gallery.html") }}"><i class="ti-more"></i>Gallery</a></li>
            <li><a href="{{ url("faq.html") }}"><i class="ti-more"></i>FAQs</a></li>
            <li><a href="{{ url("timeline.html") }}"><i class="ti-more"></i>Timeline</a></li>
          </ul>
        </li> 		  
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ url("components_alerts.html") }}"><i class="ti-more"></i>Alerts</a></li>
            <li><a href="{{ url("components_badges.html") }}"><i class="ti-more"></i>Badge</a></li>
            <li><a href="{{ url("components_buttons.html") }}"><i class="ti-more"></i>Buttons</a></li>
            <li><a href="{{ url("components_sliders.html") }}"><i class="ti-more"></i>Sliders</a></li>
            <li><a href="{{ url("components_dropdown.html") }}"><i class="ti-more"></i>Dropdown</a></li>
            <li><a href="{{ url("components_modals.html") }}"><i class="ti-more"></i>Modal</a></li>
            <li><a href="{{ url("components_nestable.html") }}"><i class="ti-more"></i>Nestable</a></li>
            <li><a href="{{ url("components_progress_bars.html") }}"><i class="ti-more"></i>Progress Bars</a></li>
          </ul>
        </li>
		...
		<li class="treeview">
          ...
          <ul class="treeview-menu">
			<li><a href="{{ url("card_advanced.html") }}"><i class="ti-more"></i>Advanced Cards</a></li>
			<li><a href="{{ url("card_basic.html") }}"><i class="ti-more"></i>Basic Cards</a></li>
			<li><a href="{{ url("card_color.html") }}"><i class="ti-more"></i>Cards Color</a></li>
		  </ul>
        </li>  
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ url("content_typography.html") }}"><i class="ti-more"></i>Typography</a></li>
            <li><a href="{{ url("content_media.html") }}"><i class="ti-more"></i>Media</a></li>
            <li><a href="{{ url("content_grid.html") }}"><i class="ti-more"></i>Grid</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ url("utilities_border.html") }}"><i class="ti-more"></i>Border</a></li>
            <li><a href="{{ url("utilities_color.html") }}"><i class="ti-more"></i>Color</a></li>
            <li><a href="{{ url("utilities_ribbons.html") }}"><i class="ti-more"></i>Ribbons</a></li>
            <li><a href="{{ url("utilities_tab.html") }}"><i class="ti-more"></i>Tabs</a></li>
            <li><a href="{{ url("utilities_animations.html") }}"><i class="ti-more"></i>Animation</a></li>
          </ul>
        </li>
		...
		<li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ url("icons_fontawesome.html") }}"><i class="ti-more"></i>Font Awesome</a></li>
            <li><a href="{{ url("icons_glyphicons.html") }}"><i class="ti-more"></i>Glyphicons</a></li>
            <li><a href="{{ url("icons_material.html") }}"><i class="ti-more"></i>Material Icons</a></li>	
            <li><a href="{{ url("icons_themify.html") }}"><i class="ti-more"></i>Themify Icons</a></li>
            <li><a href="{{ url("icons_simpleline.html") }}"><i class="ti-more"></i>Simple Line Icons</a></li>
            <li><a href="{{ url("icons_cryptocoins.html") }}"><i class="ti-more"></i>Cryptocoins Icons</a></li>
            <li><a href="{{ url("icons_flag.html") }}"><i class="ti-more"></i>Flag Icons</a></li>
            <li><a href="{{ url("icons_weather.html") }}"><i class="ti-more"></i>Weather Icons</a></li>
          </ul>
        </li> 
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ url("forms_advanced.html") }}"><i class="ti-more"></i>Advanced Elements</a></li>
            <li><a href="{{ url("forms_editors.html") }}"><i class="ti-more"></i>Editors</a></li>
            <li><a href="{{ url("forms_code_editor.html") }}"><i class="ti-more"></i>Code Editor</a></li>
            <li><a href="{{ url("forms_validation.html") }}"><i class="ti-more"></i>Form Validation</a></li>
            <li><a href="{{ url("forms_wizard.html") }}"><i class="ti-more"></i>Form Wizard</a></li>
            <li><a href="{{ url("forms_general.html") }}"><i class="ti-more"></i>General Elements</a></li>
            <li><a href="{{ url("forms_dropzone.html") }}"><i class="ti-more"></i>Dropzone</a></li>
          </ul>
        </li>
		<li class="treeview">
          <a href="{{ url("#") }}">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ url("tables_simple.html") }}"><i class="ti-more"></i>Simple tables</a></li>
            <li><a href="{{ url("tables_data.html") }}"><i class="ti-more"></i>Data tables</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ url("charts_chartjs.html") }}"><i class="ti-more"></i>ChartJS</a></li>
            <li><a href="{{ url("charts_flot.html") }}"><i class="ti-more"></i>Flot</a></li>
            <li><a href="{{ url("charts_inline.html") }}"><i class="ti-more"></i>Inline</a></li>	
            <li><a href="{{ url("charts_morris.html") }}"><i class="ti-more"></i>Morris</a></li>
            <li><a href="{{ url("charts_peity.html") }}"><i class="ti-more"></i>Peity</a></li>
            <li><a href="{{ url("charts_chartist.html") }}"><i class="ti-more"></i>Chartist</a></li>
          </ul>
        </li>  
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ url("map_google.html") }}"><i class="ti-more"></i>Google Map</a></li>
            <li><a href="{{ url("map_vector.html") }}"><i class="ti-more"></i>Vector Map</a></li>
          </ul>
        </li> 			  
		...
		<li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ url("auth_login.html") }}"><i class="ti-more"></i>Login</a></li>
			<li><a href="{{ url("auth_register.html") }}"><i class="ti-more"></i>Register</a></li>
			<li><a href="{{ url("auth_lockscreen.html") }}"><i class="ti-more"></i>Lockscreen</a></li>
			<li><a href="{{ url("auth_user_pass.html") }}"><i class="ti-more"></i>Password</a></li>
			<li><a href="{{ url("error_404.html") }}"><i class="ti-more"></i>Error 404</a></li>
			<li><a href="{{ url("error_maintenance.html") }}"><i class="ti-more"></i>Maintenance</a></li>	
          </ul>
        </li> 		  		  
								...
								<div class="col-md-6 col-12">
									<div class="box no-shadow mb-0 rounded-0">
										...
										<div class="box-body p-0">
											...
											<a class="media media-single hover-white" href="{{ url("#") }}">
									...
									<div class="box no-shadow mb-0 bg-img rounded-0" data-overlay="5" style="background-image: url(../images/gallery/landscape7.jpg)">
										<div class="box-header no-border">
											...
											<ul class="box-controls">
												<li><a href="{{ url("javascript:void(0)") }}"><i class="ti-reload text-white"></i></a></li>
											</ul>
										</div>
										<div class="box-body">
										...
										<tr>										
											<td class="pl-0 py-8">
												<div class="d-flex align-items-center">
													...
													<div>
														<a href="{{ url("#") }}" class="text-white font-weight-600 hover-primary mb-1 font-size-16">Vivamus consectetur</a>
											...
											<td class="text-right">
												<a href="{{ url("#") }}" class="waves-effect waves-light btn btn-info btn-circle mx-5"><span class="mdi mdi-bookmark-plus"></span></a>
												<a href="{{ url("#") }}" class="waves-effect waves-light btn btn-info btn-circle mx-5"><span class="mdi mdi-arrow-right"></span></a>
											</td>
										</tr>
										<tr>										
											<td class="pl-0 py-8">
