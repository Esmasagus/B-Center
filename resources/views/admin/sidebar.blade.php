<section class="sidebar">
  ...
  <ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="treeview">
      ...
      <ul class="treeview-menu">
        <li><a href="{{route('makanan.index')}}"><i class="fa fa-cutlery"></i>Food</a></li>
        <li><a href="{{route('minuman.index')}}"><i class="fa fa-glass"></i>Drink</a></li>
        <li><a href="{{route('seragam.index')}}"><i class="fa fa-mortar-board"></i>Uniform</a></li>
      </ul>
    </li>
